    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        piña.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Toast.makeText(ScrollView3.this, "Primera Imagen", Toast.LENGTH_SHORT).show();
            }
        });
        ...
        platano.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Toast.makeText(ScrollView3.this, "Segunda Imagen", Toast.LENGTH_SHORT).show();
            }
        });
        fresa.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Toast.makeText(ScrollView3.this, "Tercera Imagen", Toast.LENGTH_SHORT).show();
            }
        });
